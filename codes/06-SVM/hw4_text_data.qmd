...
As a Data Science graduate student and a machine learning enthusiast, SVM is a method that I can not avoid in machine learning. For example, if I just have a bunch of data that needs to be solved by SVM method, either Matlab's SVM toolbox, or SciKitLearn in python can provide a convenient and quick solution.
...
*Step 6 - Transfer text data to numerical feature vectors*
...
```
*Step 7 - Use SVM to predict the result*
