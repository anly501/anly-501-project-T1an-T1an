...
#### Final results
From table 1, the final result is provided. The  model accuracy is 0.58, and the error rate is 0.42. This accuracy is not good enough because the price of crypocurrency changed dramatically in recent month which is quite difficult to predict.
